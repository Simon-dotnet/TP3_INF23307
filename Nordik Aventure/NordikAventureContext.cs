...
public class NordikAventureContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product
            {
                Id = 2, Sku = "NC-TNT-002", Name = "Tente familiale 6 places", PriceToBuy = 260.00, PriceToSell = 499.00, PaybackToSupplier = 0.05,
                Status = "Actif", Weight = 6.5, SupplierId = 1, CategoryId = 1
            },
            new Product
            {
                Id = 3, Sku = "NC-TNT-003", Name = "Toile imperméable 3x3 m", PriceToBuy = 25.00, PriceToSell = 59.00, PaybackToSupplier = 0.04,
                Status = "Actif", Weight = 1.1, SupplierId = 2, CategoryId = 1
            },
            new Product
            {
                Id = 4, Sku = "NC-TNT-004", Name = "Tapis de sol isolant", PriceToBuy = 18.00, PriceToSell = 39.00, PaybackToSupplier = 0.03,
                Status = "Actif", Weight = 0.9, SupplierId = 3, CategoryId = 1
            },
            new Product
            {
                Id = 5, Sku = "NC-TNT-005", Name = "Abri cuisine pliable", PriceToBuy = 75.00, PriceToSell = 149.00, PaybackToSupplier = 0.05,
                Status = "Actif", Weight = 5, SupplierId = 1, CategoryId = 1
            },
            new Product
            {
                Id = 6, Sku = "NC-TNT-006", Name = "Mat telescopique alu", PriceToBuy = 12.00, PriceToSell = 29.00, PaybackToSupplier = 0.04,
                Status = "Actif", Weight = 0.7, SupplierId = 2, CategoryId = 1
            },
            new Product
            {
                Id = 7, Sku = "NC-SAC-001", Name = "Sac à dos 50 L etanche", PriceToBuy = 65.00, PriceToSell = 139.00, 
            ...
            new Product
            {
                Id = 9, Sku = "NC-SAC-003", Name = "Sac de couchage -10 degree", PriceToBuy = 80.00, PriceToSell = 169.00, 
            ...
            new Product
            {
                Id = 11, Sku = "NC-SAC-005", Name = "Housse impermeable sac a dos", PriceToBuy = 9.00, PriceToSell = 19.00, 
                PaybackToSupplier = 0.04, Status = "Actif", Weight = 0.4, SupplierId = 2, CategoryId = 2
            },
            new Product
            {
                Id = 12, Sku = "NC-SAC-006", Name = "Batons de marche carbone", PriceToBuy = 35.00, PriceToSell = 79.00, 
                PaybackToSupplier = 0.04, Status = "Actif", Weight = 0.8, SupplierId = 2, CategoryId = 2
            },
            new Product
            {
                Id = 13, Sku = "NC-VET-001", Name = "Chandail thermique homme", PriceToBuy = 22.00, PriceToSell = 59.00, 
                PaybackToSupplier = 0.05, Status = "Actif", Weight = 0.6, SupplierId = 5, CategoryId = 3
            },
            new Product
            {
                Id = 14, Sku = "NC-VET-002", Name = "Chandail thermique femme", PriceToBuy = 22.00, PriceToSell = 59.00, 
                PaybackToSupplier = 0.05, Status = "Actif", Weight = 0.6, SupplierId = 5, CategoryId = 3
            },
            new Product
            {
                Id = 15, Sku = "NC-VET-003", Name = "Pantalon de randonnee homme", PriceToBuy = 38.00, PriceToSell = 89.00, 
                PaybackToSupplier = 0.05, Status = "Actif", Weight = 0.8, SupplierId = 5, CategoryId = 3
            },
            new Product
            {
                Id = 16, Sku = "NC-VET-004", Name = "Pantalon de randonnee femme", PriceToBuy = 38.00, PriceToSell = 89.00, 
                PaybackToSupplier = 0.05, Status = "Actif", Weight = 0.8, SupplierId = 5, CategoryId = 3
            },
            new Product
            {
            ...
            new Product
            {
                Id = 18, Sku = "NC-VET-006", Name = "Tuque en laine merinos", PriceToBuy = 10.00, PriceToSell = 29.00, 
                PaybackToSupplier = 0.04, Status = "Actif", Weight = 0.3, SupplierId = 6, CategoryId = 3
            },
            new Product
            {
                Id = 19, Sku = "NC-VET-007", Name = "Gants isolants Hiver+", PriceToBuy = 18.00, PriceToSell = 45.00, 
            ...
            new Product
            {
                Id = 21, Sku = "NC-ACC-002", Name = "Bouteille isotherme 1L", PriceToBuy = 12.00, PriceToSell = 29.00,
                PaybackToSupplier = 0.03, Status = "Actif", Weight = 0.4, SupplierId = 3, CategoryId = 4
            },
            new Product
            {
                Id = 22, Sku = "NC-ACC-003", Name = "Lampe frontale 300 lumens", PriceToBuy = 14.00, PriceToSell = 39.00,
                PaybackToSupplier = 0.05, Status = "Actif", Weight = 0.2, SupplierId = 1, CategoryId = 4
            },
            new Product
            {
                Id = 23, Sku = "NC-ACC-004", Name = "Ensemble vaisselle 4 pers.", PriceToBuy = 20.00, PriceToSell = 49.00,
            ...
            new Product
            {
                Id = 25, Sku = "NC-ACC-006", Name = "Couteau multifonction", PriceToBuy = 15.00, PriceToSell = 39.00,
                PaybackToSupplier = 0.04, Status = "Actif", Weight = 0.5, SupplierId = 4, CategoryId = 4
            },
            new Product
            {
                Id = 26, Sku = "NC-ELE-001", Name = "Montre GPS plein air", PriceToBuy = 120.00, PriceToSell = 279.00,
            ...
            new Product
            {
                Id = 30, Sku = "NC-ELE-005", Name = "Lampe USB rechargeable", PriceToBuy = 11.00, PriceToSell = 25.00,
